      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {milestones.map((milestone, index) => (
            <Card key={milestone.quarter} className="bg-white/5 border-white/15 backdrop-blur-[2px] relative overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardTitle className="text-foreground text-xl md:text-2xl lg:text-3xl">
                  {milestone.title}
                </CardTitle>
              </CardHeader>
              <CardContent>
